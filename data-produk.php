...
<body>
    ...
    <div class="section">
        <div class="container">
            <h3>Data Produk</h3>
            <div class="box">
                <p><a href="tambah-produk.php"><button type="button" class="btn btn-primary">Tambah Data</button></a></p>
              <table border="table table-striped" cellspacing="0" class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="edit-produk.php?id=<?php echo $row['product_id'] ?>"><button type="button" class="btn btn-warning float-start">Edit</button></a>
                            <a href="proses-hapus.php?idp=<?php echo $row['product_id'] ?>" onclick="return confirm('Yakin ingin hapus ?')"><button type="button" class="btn btn-danger float-end">Hapus</button></a>
                        </td>
                    </tr>
                    <?php }}else{ ?>
                        <tr>
